...
function PicrossSplashInner() {
  ...
  return (
    <div className="nonogram-root" style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: 0, paddingTop: 24, position: "relative", background: '#cca3ff', minHeight: '100vh', width: '100%', colorScheme: 'light' }}>
      ...
      <h1 ref={dailyTitleRef} style={{ fontFamily: COURIER_FONT, fontSize: 'clamp(22px, 7.5vw, 36px)', lineHeight: 1, marginTop: 75, marginBottom: 20, fontWeight: 900, letterSpacing: 3, color: '#111', visibility: 'hidden', whiteSpace: 'nowrap' }}>Daily Nonograms</h1>
