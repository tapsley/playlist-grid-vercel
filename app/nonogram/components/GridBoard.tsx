      ...
      {(displayGrid as CellState[][]).map((row: CellState[], r: number) => {
        ...
        return (
          <div key={r} style={{ display: 'flex' }}>
            <div style={{ width: leftWidth, height: cellPx, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', fontSize: CLUE_FONT_PX, paddingRight: 6, background: (r % 2 === 0) ? '#e8e8e8' : '#ffffff', overflow: 'hidden' }}>
